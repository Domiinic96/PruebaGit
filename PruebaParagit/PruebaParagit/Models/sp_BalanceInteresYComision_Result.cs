...
namespace PruebaParagit.Models
{
    ...
    public partial class sp_BalanceInteresYComision_Result
    {
        public string Cobrador { get; set; }
        public string Contrato { get; set; }
        public string NombreCliente { get; set; }
        public Nullable<decimal> CuotasVencidas { get; set; }
        public Nullable<decimal> DiasVencidas { get; set; }
        ...
        public Nullable<decimal> ValorCuotaMora { get; set; }
